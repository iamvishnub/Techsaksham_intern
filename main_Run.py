...
def manually_fill():
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def enter_data_DB():
                connection.commit()  # Ensure data is committed to the database
            ...
            def create_csv():
                ...
                csv_name = 'Attendance/Manually Attendance/OOP_2019_02_22_Time_11_32_41.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'Attendance\Manually Attendance\OOP_2019_02_22_Time_11_32_41.csv')
    ...
    def log_in():
        ...
        if username == 'vishnu':
            if password == 'iamvishnub':
                ...
                cs = r'StudentDetails\StudentDetails.csv'
